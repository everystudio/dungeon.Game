...
public class AdsBanner : MonoBehaviour {
...
#elif UNITY_ANDROID
    string adUnitIdTate = "ca-app-pub-5869235725006697/9574133160";
	string adUnitIdYoko = "ca-app-pub-5869235725006697/9574133160";
#elif UNITY_IPHONE
	string adUnitIdTate = "ca-app-pub-5869235725006697/4864731963";
	string adUnitIdYoko = "ca-app-pub-5869235725006697/4864731963";
#else
	...
	void showAdBanner(DeviceOrientationDetector.ORIENTATION _orientation)
	{
		...
		else
		{
			...
			if (viewYoko == null)
			{
				BannerView bannerViewYoko = new BannerView(adUnitIdYoko, AdSize.Banner, AdPosition.TopLeft);
				// Create an empty ad request.
